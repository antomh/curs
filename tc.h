...
#define tc_move_cursor_left(N)  printf("\033[%dD", N)
#define tc_move_cursor_right(N) printf("\033[%dC", N)
#define tc_move_cursor_up(N)    printf("\033[%dA", N)
#define tc_move_cursor_down(N)  printf("\033[%dB", N)
